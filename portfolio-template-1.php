...
$portfolio_columns =  $NHP_Options->get("portfolio_columns");
...
<div id="portfolio-page">
    ...
    <?php if (($NHP_Options->get("folio_sorting") != '') && ($portfolio_columns !='1column') && (!$folio_custom_categories)) {
    ?>
...
<?php } ?>
    ...
    <div class="works-list">
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            if ($portfolio_columns == '2column') {

                $article_image = aq_resize($img_url, 580, 280, true); //resize & crop img
                $class_col = 'six';

            } elseif ($portfolio_columns == '3column') {

                $article_image = aq_resize($img_url, 380, 280, true); //resize & crop img
                $class_col = 'four';

            } elseif ($portfolio_columns == '4column') {
            ...
            $portfolio_style = $NHP_Options->get("portfolio_style");
