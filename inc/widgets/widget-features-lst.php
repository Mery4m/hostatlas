...
class crum_widget_features extends WP_Widget {
	...
	function crum_widget_features() {

		/* Widget settings. */

		$widget_ops = array( 'classname' => 'service-box', 'description' => __( 'Display Features with icons','crum') );

		/* Widget control settings. */

		$control_ops = array( 'id_base' => 'crum_widget_features' );

		/* Create the widget. */

		$this->WP_Widget( 'crum_widget_features', 'Theme: Features blocks', $widget_ops, $control_ops );
