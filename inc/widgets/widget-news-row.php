...
class crum_news_row extends WP_Widget {
	...
	function crum_news_row() {
		...
		$widget_ops = array( 'classname' => 'latest-news-block', 'description' => __( 'Display news/articles row from some category','crum') );
		...
		$this->WP_Widget( 'crum_news_row', 'Theme: News / Articles row', $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
        ...
        */
        ...
        $the_query = new WP_Query( 'cat = '.$categ.'&posts_per_page='. $numb_col .'&orderby='.$post_order_by.'&order='.$post_order.'' );
